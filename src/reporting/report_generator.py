    ...
    def generate_report(self, student_info, violations, output_format='pdf'):
        ...
        try:
            ...
            if output_format.lower() == 'pdf':
                ...
                pdfkit_config_path = self.config.get('wkhtmltopdf_path')
                pdfkit_config = None
                if pdfkit_config_path and os.path.exists(pdfkit_config_path):
                ...
                try:
                    ...
                    # Fallback to HTML when wkhtmltopdf is unavailable.
